Development of fieldworkimport plugin
===========================



The code for the plugin is in the [fieldworkimport](../fieldworkimport) folder. Make sure you have required tools, such as
...
* they contain absolute imports:
    ```python
    from fieldworkimport.utils.exceptions import TestException # Good
...
* Add this badge ![](https://github.com/my-organization/fieldworkimport/workflows/Translations/badge.svg) to
