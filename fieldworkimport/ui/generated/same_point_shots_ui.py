...
class Ui_SamePointShotsDialog(object):
    def setupUi(self, SamePointShotsDialog):
        ...
        SamePointShotsDialog.setWindowModality(QtCore.Qt.WindowModal)
        SamePointShotsDialog.resize(959, 644)
        ...
        self.buttonBox.accepted.connect(SamePointShotsDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(SamePointShotsDialog.reject) # type: ignore
    ...
    def retranslateUi(self, SamePointShotsDialog):
        ...
        self.tree_widget.headerItem().setText(1, _translate("SamePointShotsDialog", "Decription"))
        self.tree_widget.headerItem().setText(2, _translate("SamePointShotsDialog", "Northing"))
        self.tree_widget.headerItem().setText(3, _translate("SamePointShotsDialog", "Easting"))
        self.tree_widget.headerItem().setText(4, _translate("SamePointShotsDialog", "Elevation"))
        self.tree_widget.headerItem().setText(5, _translate("SamePointShotsDialog", "Residual N"))
        self.tree_widget.headerItem().setText(6, _translate("SamePointShotsDialog", "Residual E"))
        self.tree_widget.headerItem().setText(7, _translate("SamePointShotsDialog", "Residual El"))
