...
class Ui_SamePointShotsDialog(object):
    ...
    def retranslateUi(self, SamePointShotsDialog):
        ...
        self.tree_widget.headerItem().setText(1, _translate("SamePointShotsDialog", "Description"))
        self.tree_widget.headerItem().setText(2, _translate("SamePointShotsDialog", "Easting"))
        self.tree_widget.headerItem().setText(3, _translate("SamePointShotsDialog", "Northing"))
        ...
        self.tree_widget.headerItem().setText(6, _translate("SamePointShotsDialog", "Residual N"))
